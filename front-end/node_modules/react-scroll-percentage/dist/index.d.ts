 ...
 * */
export interface ScrollPercentagePlainChildrenProps extends ScrollPercentageOptions {
...
export declare type ScrollPercentageHookResponse = [((node?: Element | null) => void), number, IntersectionObserverEntry | undefined];
